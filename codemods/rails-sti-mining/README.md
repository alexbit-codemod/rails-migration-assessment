...
Read-only **mining codemod** that detects ActiveRecord single-table inheritance for Rails migration assessment. No files are written to the target repo.
...
| --- | --- |
| `rails-sti` | `className`, `parentClass`, `risk`, `file`, `line`, `snippet` |
